...
export default class SiteArmy extends React.Component<Props, State>{
  ...
  render(){
    ...
    const childProps = {assets,service: ArmyInfo,appPage,titlePath: '/army'};
    return <div>
              ...
              <Route exact path={match.url + "/leaders/:id"} render={withServicesInfo(LeadershipDetailsPage,{...childProps, titlePath: '/army/leaders', leftIcon: <BackButton path={match.url + "/leaders"} />})} />
    </div>;
  }
}